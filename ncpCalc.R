function (percentile1, percentile2, df1, df2, ncp.initial, N, Fobs) {
    ...
    ## It seems as though the function fails iff one of these fail
    ## Calculate the F quartile for the lower percentile, for the initial ncp
    ## Calculate
    
    tryCatch({
        F.quartile <- qf(percentile1, df1, df2, ncp.initial)              
